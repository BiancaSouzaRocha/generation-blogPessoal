...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsario () {
		...
		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario> (new Usuario (0L,
				"Paulo Antunes", "paulo_antunes@email.com", "12345678"));
	...
	public void naoDeveDuplicarUsuario () {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L,
				"Maria da Silva", "maria@email.com", "1234560")); 
	...
	public void deveMostrarTodosUsuarios () {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L,
				"Sabrina Sanches", "sabrina_sanches@email.com", "1254632"));
		usuarioService.cadastrarUsuario(new Usuario(0L,
				"Ricardo Marques", "ricardo_marques@email.com", "1234560"));
